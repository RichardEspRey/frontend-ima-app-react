-- Estatus de cajas · tabla para lo que se captura a mano
--
...
CREATE TABLE IF NOT EXISTS `caja_estatus` (
  ...
  `ubicacion`          VARCHAR(20)  DEFAULT NULL COMMENT 'PENSION NLD, TALLER, RUTA SUBIENDO, RUTA BAJANDO',
  `observacion`        VARCHAR(10)  DEFAULT NULL COMMENT 'VACIA o CARGADA',
