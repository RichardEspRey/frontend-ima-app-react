            ...
            <DialogContent>
                <Stack spacing={3} sx={{ mt: 1 }}>
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={6}>
                            <TextField select label="Categoría" size="small" fullWidth value={newField.categoria} onChange={(e) => setNewField({...newField, categoria: e.target.value})}>
                        ...
                        <Grid item xs={6}>
                            <TextField select label="Tipo" size="small" fullWidth value={newField.tipo} onChange={(e) => setNewField({...newField, tipo: e.target.value})}>
                                <MenuItem value="file">Subir Archivo</MenuItem>
                                <MenuItem value="text">Input Texto Libre</MenuItem>
                            </TextField>
                        </Grid>
                    </Grid>
                    {newField.tipo === 'file' && (
