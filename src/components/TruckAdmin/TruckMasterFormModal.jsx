...
const TruckMasterFormModal = ({ open, onClose, truckData, setTruckData, truckDocs, setTruckDocs, configFields, categories, handleSaveTruck, loading }) => {
    return (
...
export default TruckMasterFormModal;