...
import TripResources from './TripFormMX/TripResources';
import TripStageItem from './TripFormMX/TripStageItem';
...
const initialEtapaStateBase = {
    ...
    documentos: { ...initialNormalTripDocs }, time_of_delivery: '', time_of_departure: '', stops_in_transit: []
};

const TripFormMX = ({ tripNumber, countryCode, tripYear, isTransnational, isContinuation, transnationalNumber, movementNumber, onSuccess, etapas: etapasProp, setEtapas: setEtapasProp, formData: formDataProp, setFormData: setFormDataProp, onSaveOverride }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const etapasJson = etapas.map(etapa => ({
            ...
            time_of_departure: etapa.time_of_departure || '',
            estatus: 'Up Coming',
