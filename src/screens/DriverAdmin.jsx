        ...
        try {
            ...
            if (data.status === 'success' && data.Users) {
              const formatted = data.Users.map(user => ({
                ...
                // Mapeo de documentos
                APTO_tipo: user.APTO_tipo || '', APTO_fecha: user.APTO_fecha || '', APTO_URL: user.APTO_URL || '',
                I94_tipo: user.I94_tipo || '', I94_fecha: user.I94_fecha || '', I94_URL: user.I94_URL || '',
                VISA_tipo: user.VISA_tipo || '', VISA_fecha: user.VISA_fecha || '', VISA_URL: user.VISA_URL || '',
                Licencia_tipo: user.Licencia_tipo || '', Licencia_fecha: user.Licencia_fecha || '', Licencia_URL: user.Licencia_URL || '',
              }));
